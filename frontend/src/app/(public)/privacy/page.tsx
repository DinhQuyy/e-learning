...
export const metadata: Metadata = {
  ...
  description:
    "Mô tả cách Kiwi thu thập, sử dụng, lưu trữ và bảo vệ dữ liệu cá nhân của người dùng.",
};
...
const privacySections: PrivacySection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Kiwi không bán, cho thuê hoặc trao đổi dữ liệu cá nhân cho mục đích quảng cáo bên ngoài.",
    ],
  },
  {
        ...
        <div className="mx-auto max-w-7xl px-4 pb-14 pt-14 sm:px-6 lg:px-8 lg:pb-16 lg:pt-18">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg">
              Chính sách này mô tả cách Kiwi thu thập, sử dụng và bảo vệ thông tin cá nhân khi bạn đăng ký,
